...
# 导入视图集
from domain.views import DomainManageViewSet, DomainAnalysisViewSet,AliyunCloudDomainManageView,AliyunCloudDomainAnalysisView,TenCentCloudDomainManageView
